	    ...
	    <div class="col-lg-12">
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                ...
	                <form role="form" action="/qna_board/modify" method="post">
	...
	<sec:authentication property="principal" var="pinfo"/>
		<sec:authorize access="isAuthenticated()">
			<c:if test="${pinfo.username eq board.writer }">
				<button type="submit" data-oper="modify" class="btn btn-default" onmouseover="this.style.background='#46C6C6';">수정</button>
				<button type="submit" data-oper="remove" class="btn btn-default" onmouseover="this.style.background='#E16A9D';">삭제</button>
			</c:if>
		</sec:authorize>
	<button type="submit" data-oper="list" class="btn btn-default" onmouseover="this.style.background='#6482B9';">목록</button>
</div>
...
$(document).ready(function(){
	...
	$('button').on("click",function(e){
		...
		if(operation==='remove'){
			formObj.attr("action","/qna_board/remove");
		}else if(operation==='list'){
			formObj.attr("action","/qna_board/list").attr("method","get");
...
$(document).ready(function(){
	(function(){
		...
		$.getJSON("/qna_board/getAttachList",{bno:bno},function(arr){
			console.log(arr);
