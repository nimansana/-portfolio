	        ...
	        <div class="panel panel-default">
	            <div class="panel-heading">
	            	...
	            	<div class="panel-body">
		           		...
		           		<div class="form-group">
		           			<label>Title</label>
		           			<input class="form-control" name="title" readonly="readonly" value="${notice.title }">
		           		</div>
		           		<div class="form-group">
		           			<label>Text area</label>
		           			<textarea class="form-control" rows="3" name="content" readonly="readonly">${notice.content }</textarea>
		           		</div>
		           		<div class="form-group">
		           			<label>Writer</label>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						<a id="addReplyBtn" class="button pull-right" id="regBtn">새 댓글</a>
					</sec:authorize>
					<sec:authorize access="isAuthenticated()">
						<c:if test="${pinfo.username eq board.writer }">
							<a id="addReplyBtn" class="button pull-right">새 댓글</a>
						</c:if>
					</sec:authorize>
				</div>
