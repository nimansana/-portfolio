...
import org.zerock.service.ProductReplyService;

import lombok.AllArgsConstructor;
import lombok.extern.log4j.Log4j;

@RequestMapping("/product_replies/")
@RestController
@Log4j
@AllArgsConstructor
public class ProductReplyController {
	...
	public ResponseEntity<ProductReplyPageDTO> getList(
		...
		ProductReplyPageDTO ReplyPageDTO=service.getListPage(cri, bno);
	...
	@GetMapping(value="/{rno}",
			produces= {MediaType.APPLICATION_XML_VALUE,
					MediaType.APPLICATION_JSON_UTF8_VALUE})
	public ResponseEntity<ProductReplyVO> get(@PathVariable("rno") Long rno){
